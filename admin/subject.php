    ...
    <table class="table ps-3 pe-3" id="subjectTable" data-toggle="table" data-sortable="true" data-classes="table">
        <thead>
            <tr class="custom-header">
                ...
                <th class="ps-3 pe-4" data-sortable="true">Subject Name</th>
                <th class="ps-3 pe-4" data-sortable="true">Subject Code</th>
                <th class="ps-3 pe-4" data-sortable="true">Department</th>
