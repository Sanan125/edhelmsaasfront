...
<body>
    ...
    <div class="main-content px-5">
        ...
        <div class="card p-4" style="margin-left: 62px; margin-right: 62px;">
            <div class="card-header bg-white d-flex flex-column justify-content-start align-items-start">
                <div>
                    <h5 class="mb-0 fw-bold">Add New Student</h5>
                    <small class="fw-normal">Fill in the details below to add a new student.</small>
                </div>

                <!-- Upload in bulk checkbox -->
                <div class="form-check mt-3">
                    <input class="form-check-input" type="checkbox" id="bulkUploadCheckbox">
                    <label class="form-check-label" for="bulkUploadCheckbox">
                        Upload in bulk
                    </label>
                </div>

                <!-- Bulk upload section -->
                <div id="bulkUploadDiv" style="display: none; margin-top: 10px;">
                    ...
                    <form action="add_student_process.php" method="POST" enctype="multipart/form-data">
                        <div class="my-2">
                            <input type="file" class="form-control form-control-sm" name="bulk_upload" accept=".csv,.xlsx,.xls" required>
                        </div>
                    </form>
                </div>
            </div>
