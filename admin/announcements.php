...
<body>
    ...
    <div class="main-content px-5">
        ...
        <div class="card pb-2" style="margin-left: 62px; margin-right: 62px;">
...
<div class="card-body mt-4">
    <div class="mb-4">
        <div class="card shadow-sm rounded mb-3">
            ...
            <div class="card-body">
                <p class="font-weight-bold mb-3">Important Announcement:</p>
                <ul class="list-unstyled pl-3">
                    <li class="mb-2"><i class="fas fa-check-circle text-success"></i> Mid-Term Exams will begin from June 15th. Please be prepared.</li>
                    <li class="mb-2"><i class="fas fa-check-circle text-success"></i> Ensure to submit all documents before the exam date.</li>
                    <li class="mb-2"><i class="fas fa-check-circle text-success"></i> The final exam schedule will be announced soon.</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="mb-4">
        <div class="card shadow-sm rounded mb-3">
            ...
            <div class="card-body">
                ...
                <ul class="list-unstyled pl-3">
                    <li class="mb-2"><i class="fas fa-check-circle text-success"></i> The final exam schedule will be announced soon.</li>
                    <li class="mb-2"><i class="fas fa-check-circle text-success"></i> Stay tuned for updates.</li>
                </ul>
            </div>
        </div>
    </div>
