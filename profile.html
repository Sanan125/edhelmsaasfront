    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../admin/syllabus.html">
...
<div class="tab-content" id="pills-tabContent">
  ...
  <div class="tab-pane fade show active" id="pills-account" role="tabpanel" aria-labelledby="pills-account-tab">
    <div class="row pt-3 pb-3">
      <!-- Left Column: 40% width (Personal Information) -->
      <div class="col-2">
      ...
      <!-- Right Column: 60% width (Profile Update Form) -->
      <div class="col-10">
        <form>
          <!-- Profile Image Upload Section -->
          <!-- <div class="mb-3">
            <label for="profileImage" class="form-label">Upload Profile</label>
          ...
          <button type="submit" class="btn btn-primary d-block ms-auto w-25">Update Profile</button>
        </form>
      </div>
    </div>
  </div>
 ...
 <div class="tab-pane fade" id="pills-security" role="tabpanel" aria-labelledby="pills-security-tab">
    <div class="row pt-3 pb-3">
      <!-- Left Column: 40% width (Security Information) -->
      <div class="col-2">
      ...
      <!-- Right Column: 60% width (Security Settings Form) -->
      <div class="col-10">
    <form>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <span class="input-group-text" id="eyeCurrentPassword" onclick="togglePasswordVisibility('currentPassword')">
                <i class="bi bi-eye"></i>
              </span>
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <span class="input-group-text" id="eyeNewPassword" onclick="togglePasswordVisibility('newPassword')">
                <i class="bi bi-eye"></i>
              </span>
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <span class="input-group-text" id="eyeConfirmPassword" onclick="togglePasswordVisibility('confirmPassword')">
                <i class="bi bi-eye"></i>
              </span>
            </div>
          </div>
          ...
          <button type="submit" class="btn btn-primary d-block ms-auto w-25">Update Security Settings</button>
        </form>
      </div>
    </div>
  </div>
...
<div class="tab-pane fade" id="pills-billing" role="tabpanel" aria-labelledby="pills-billing-tab">
  <div class="row pt-3 pb-3">
    <div class="col-12">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <td>PEB15918</td>
            <td>11 May, 2024</td>
            <td>Enterprise Plan (Extended)</td>
      ...
      <!-- Pagination -->
      <nav aria-label="Page navigation example ms">
    ...
    <div class="col-md-12">
      ...
      <table class="table mt-3">
        ...
        <tbody>
          ...
          <!-- Continue adding log entries as needed -->
        </tbody>
      </table>

      <!-- Log Out Button -->
      <a href="#" class="btn btn-link text-decoration-none d-flex justify-content-end">
