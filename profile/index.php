...
<div class="profile-body container mt-5">
  <div class="row align-items-start">
    ...
    <div class="col-md-3 text-center">
      <img src="../assests/images/default.png" alt="Profile Picture" class="img-fluid profile-pic mt-5 mb-4" style="max-width: 260px;">

      <!-- Name and Details under image -->
      <div>
        <h5 class="mb-1">Sanan Saleem</h5>
        <p class="text-primary mb-1 meduim">Computer Teacher</p>
        <p class="text-muted small"><i class="bi bi-geo-alt me-1"></i>Bahria town</p>
      </div>
    </div>
  ...
  <span class="text-warning ms-2">★ ★ ★ ★ ☆</span>
        ...
        <div>
<button class="btn btn-outline-primary btn-sm me-2 mb-3">
